...
<body>
	<div id="header">
		...
		<tr>
			...
			<td><center><a href ="Login.jsp"><img src="image/login.jpg" width="100" height="80"/></a><a href ="Login.jsp" style="text-decoration:none"><h3 style="color: #e8daef">
			<form method="POST" action="Login.jsp">Log In</form></h3></a></center></td>
			<td><center><a href ="user.jsp"><img src="image/sighn.jpg" width="100" height="80"/></a><a href ="user.jsp" style="text-decoration:none"><h3 style="color: #e8daef">
			<form method="POST" action="user.jsp">Sign In</form></h3></a></center></td>
	...
	<div id="nav">	
		...
		<tr>
			...
			<td><a href ="loginA.jsp"><b>Admin Panel</b></a></td>
