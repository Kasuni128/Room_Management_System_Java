...
<div align="left">
	  ...
	  <table border="1" cellpadding="12">
		 ...
		 <h2 class="h2"><b>View User</b></h2>
		
		 <a href="manageuser.jsp" style="text-decoration:none"><h2>+ Add User</h2></a>
		  <tr>
                <th>User ID</th>
                <th>User Name</th>
                <th>Mobile</th>
			...
			%>
			 <tr>
				...
				<input type="hidden" name="userID" value="<%=user.getUserID()%>"/>
				 <input type="submit" value= "Edit/Delete User" class="select-button" /> 
				 </form>
				 </td>	
				</tr>			
			<%	
